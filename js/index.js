...
console.log(date.toLocaleDateString('en-Us',{month:'short'}))
...
async function getweatherData(cityName){
    ...
    // let weatherResponse = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=71dbd040c45b418aa92175158231802&q=${cityName}&days=3`)
    let weatherDataResp = await weatherResponse.json();
...
// display tomorrow and after tomorrow
